...
//!   `AgentContext`, `EnricherDescriptor`, `ExtractorConfig`
//! - [`traits`] — Ports: `CatalogRepository`, `FactStore`, `FileSystem`, `Extractor`
...
pub use crate::models::{
    ...
    OperationInvocation, OperationResult, TestSummary,
};
pub use crate::traits::{CatalogRepository, EnrichmentError, Extractor, FactStore, FileSystem};
