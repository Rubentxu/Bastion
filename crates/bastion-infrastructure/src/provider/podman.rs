    ...
    async fn create(
        ...
        let container_config = bollard::models::ContainerCreateBody {
            ...
            host_config: Some(bollard::models::HostConfig {
                ...
                // This is needed because Podman's default DNS doesn't always resolve host.containers.internal
...
impl TaskExecutor for PodmanProvider {
    ...
    async fn copy_to(
        ...
        // Build an in-memory tarball of the host directory
        ...
        // Upload to container using bollard upload_to_container
        // Options include the target path in the container
